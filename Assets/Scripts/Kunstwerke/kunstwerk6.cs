...
public class kunstwerk6 : MonoBehaviour
{
    //Ziffern im Wald!!! 
    ...
    float Kunstwerk6lat = 47.949589f;
    float Kunstwerk6long = 12.676955f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk6long - longitude;
        float b = Kunstwerk6lat - latitude;
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk6lat + 0.00007f && latitude > Kunstwerk6lat - 0.00007f && longitude < Kunstwerk6long + 0.00007f && longitude > Kunstwerk6long - 0.00007f)
                {
                    PopUp.gameObject.SetActive(true);
                    Handheld.Vibrate();
                    counter.GetComponent<counter>().kunstwerke = 6;
                }
                else
                {
