...
public class kunstwerk10 : MonoBehaviour
{
    //AEIOU
    ...
    float Kunstwerk10lat = 47.949635f;
    float Kunstwerk10long = 12.676475f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk10long - longitude;
        float b = Kunstwerk10lat - latitude;
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk10lat + 0.00007f && latitude > Kunstwerk10lat - 0.00007f && longitude < Kunstwerk10long + 0.00007f && longitude > Kunstwerk10long - 0.00007f)
                {
                    PopUp.gameObject.SetActive(true);
                    Handheld.Vibrate();
                    counter.GetComponent<counter>().kunstwerke = 10;
                }
                else
                {
