...
public class kunstwerk3 : MonoBehaviour
{
    //Drugs & Liquor !!!1
    ...
    float Kunstwerk3lat = 47.949253f;
    float Kunstwerk3long = 12.677159f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk3long - longitude;
        float b = Kunstwerk3lat - latitude;
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk3lat + 0.00007f && latitude > Kunstwerk3lat - 0.00007f && longitude < Kunstwerk3long + 0.00007f && longitude > Kunstwerk3long - 0.00007f)
                {
                    PopUp.gameObject.SetActive(true);
                    Handheld.Vibrate();
                    counter.GetComponent<counter>().kunstwerke = 3;
                }
                else
                {
