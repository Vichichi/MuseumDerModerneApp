...
public class kunstwerk4 : MonoBehaviour
{
    //Sky Space !!! 
    ...
    float Kunstwerk4lat = 47.949337f;
    float Kunstwerk4long = 12.677331f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk4long - longitude;
        float b = Kunstwerk4lat - latitude;
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk4lat + 0.00007f && latitude > Kunstwerk4lat - 0.00007f && longitude < Kunstwerk4long + 0.00007f && longitude > Kunstwerk4long - 0.00007f)
                {
                    PopUp.gameObject.SetActive(true);
                    Handheld.Vibrate();
                    counter.GetComponent<counter>().kunstwerke = 4;
                }
                else
                {
