...
public class kunstwerk11 : MonoBehaviour
{
    //AEIOU
    ...
    float Kunstwerk11lat = 47.949200f;
    float Kunstwerk11long = 12.676651f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk11long - longitude;
        float b = Kunstwerk11lat - latitude;
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk11lat + 0.00007f && latitude > Kunstwerk11lat - 0.00007f && longitude < Kunstwerk11long + 0.00007f && longitude > Kunstwerk11long - 0.00007f)
                {
