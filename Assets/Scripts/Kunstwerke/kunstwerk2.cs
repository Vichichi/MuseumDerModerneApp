...
public class kunstwerk2 : MonoBehaviour
{
    ...
    float Kunstwerk2lat = 47.949065f;
    float Kunstwerk2long = 12.676708f;
    ...
    public void Distanz()
    {
        ...
        float a = Kunstwerk2long - longitude;
        float b = Kunstwerk2lat - latitude;
        ...
        {
            DistanceText.text = "30m to the artwork";
        }
    ...
    IEnumerator TestLocation()
    {
        ...
        else
        {
            while (true)
            {
                ...
                //MdM
                if (latitude < Kunstwerk2lat + 0.00007f && latitude > Kunstwerk2lat - 0.00007f && longitude < Kunstwerk2long + 0.00007f && longitude > Kunstwerk2long - 0.00007f)
                {
                    PopUp.gameObject.SetActive(true);
                    Handheld.Vibrate();
                    counter.GetComponent<counter>().kunstwerke = 2;
                }
                else
                {
